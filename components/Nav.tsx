...
export default function Nav() {
  ...
  return (
    ...
    >
      <div className="px-8 md:px-16 lg:px-24 2xl:px-32 3xl:px-48 h-16 2xl:h-20 flex items-center justify-between max-w-6xl 2xl:max-w-7xl 3xl:max-w-[1600px] mx-auto w-full">
        <Link
          href="/"
